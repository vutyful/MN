...
public class AdminADController {
	...
	@RequestMapping(value = "manager/click.do")
	public String adClick(AdVO vo, String ad_link) {
		

		adService.adClick(vo);
		
		System.out.println("광고 클릭수증가");
		final String temp =  "redirect:" + ad_link;
