				...
				<div id="collapseUtilities" class="collapse show"
					...
					<div class="bg-white py-2 collapse-inner rounded">
						...
						<a class="collapse-item active"
							href="/mn/manageMembers/MembersList.do">회원 목록</a>
					</div>
				</div></li>
			...
			<div id="content">
				...
				<nav
					...
					<h1 class="h3 mb-4 text-gray-800"
						style="margin-bottom: 0.5rem !important">회원 관리</h1>
					...
					<div class="row">
						...
						<div class="col-lg-6">
							...
							<div class="card shadow mb-4">
								<form class="user" id="myform" action="modifyMember.do"
									method="post">
									<div class="card-body">
										<h6 class="m-0 font-weight-bold text-primary"
											style="margin-bottom: 0.5rem !important">회원번호</h6>
										<input type="text" name="id" value="${member.mem_num}"
											disabled />
										<h6 class="m-0 font-weight-bold text-primary"
											style="margin-bottom: 0.5rem !important">아이디</h6>
										<input type="text" name="id" value="${member.mem_email}"
											disabled />
										<h6 class="m-0 font-weight-bold text-primary"
											style="margin-bottom: 0.5rem !important">이 름</h6>
										...
										<h6 class="m-0 font-weight-bold text-primary"
											style="margin-bottom: 0.5rem !important">전화번호</h6>
										<input type="text" name="name" value="${member.mem_tel}"
											disabled />				
										<h6 class="m-0 font-weight-bold text-primary"
											style="margin-bottom: 0.5rem !important">권 한</h6>
										...
										<h6 class="m-0 font-weight-bold text-primary"
											style="margin: 0.5rem 0 !important">프로필 이미지</h6>
										<%--
	                                    <c:choose>
