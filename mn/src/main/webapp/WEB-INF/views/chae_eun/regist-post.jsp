...
<head>
    ...
    <!-- summernote-dist --> 
    <link rel="stylesheet" href="resources/summernote-dist/summernote-lite.css">
...
<body>
    ...
    <header class="header-area">
        ...
        <!-- Top Header Area -->
        <div class="top-header-area bg-img bg-overlay" style="background-image: url(resources/bueno/img/bg-img/header.jpg);">
        ...
        <!-- Logo Area -->
        <div class="logo-area">
            <a href="index.jsp"><img src="resources/bueno/img/core-img/logo.png" alt=""></a>
        </div>
    ...
    <div class="treading-post-area" id="treadingPost">
        ...
        <div class="single-blog-post style-1 d-flex flex-wrap mb-30">
            ...
            <div class="blog-content">
                ...
                <a href="#" class="post-title">고냥씨 데리고 온날</a>
                <div class="post-meta">
                    <a href="#" class="post-date">July 11, 2018</a>
                    <a href="#" class="post-author">By 송채은</a>
                </div>
            </div>
        </div>
        ...
        <div class="single-blog-post style-1 d-flex flex-wrap mb-30">
            ...
            <div class="blog-content">
                <a href="#" class="post-tag">The Best</a>
                <a href="#" class="post-title">고냥씨 목욕한 날</a>
                <div class="post-meta">
                    <a href="#" class="post-date">July 11, 2018</a>
                ...
                <div class="col-12 col-lg-8 col-xl-9">
                    <div class="post-details-content mb-100">
						...
						<form action="regist.do" method="get">
							...
							<textarea placeholder="제목을 입력해 주세요." name="boardTitle" id="boardTitle" style="height:50px;width:100%"></textarea>
							<!-- summernote  -->
