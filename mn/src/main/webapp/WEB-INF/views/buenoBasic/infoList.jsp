...
<!--     <div class="preloader d-flex align-items-center justify-content-center">
    ...
    <header class="header-area">
        ...
        <!-- Logo Area -->
        <div class="logo-area">
            <a href="main.do"><img src="../resources/idximg/logo2.png" alt=""></a>
        </div>
    ...
    <div class="treading-post-area" id="treadingPost">
        ...
        <div class="single-blog-post style-1 d-flex flex-wrap mb-30">
            ...
            <div class="blog-content">
                ...
                <div class="post-meta">
                    <a href="#" class="post-date">글 작성 날짜</a>
                    <a href="#" class="post-author">By 작성자</a>
                </div>
            </div>
        </div>
    ...
    <!-- ##### Search Area Start ##### -->
    <div class="bueno-search-area section-padding-100-0 pb-70 bg-img" style="background-color: #F2EAD3;">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <form action="#" method="post">
...
<!--                             <div class="col-12 col-sm-6 col-lg-3">
                            ...
                            <div class="col-12 col-sm-6 col-lg-3">
                                <div class="mb-30 col-sm-6 ">
                                   <input type="text" name="keyword" class="form-control" style="width:250px; height: 50px;"/>
                                </div>
                            </div>
                            <div class="col-12 col-sm-6 col-lg-3">
                                <div class="form-group mb-30">
                                    <button class="btn bueno-btn w-100">검색</button>
                                </div>
                            </div>
                            <!-- 관리자만 글쓰기 버튼 생성되게 만들어야함 -->
                             <div class="col-12 col-sm-6 col-lg-3">
                                <div class="form-group mb-30">
                                    <button class="btn bueno-btn w-100" type="button" onclick="location.href='infoWrite.do'">글쓰기</button>
                                </div>
                            </div>
                        </div>
                    </form>
    ...
    <div class="catagory-post-area">
        <div class="container">
    		<div style="padding:80px;">
    			<h2 style="color:black; text-align: center;">강아지 음식</h2>
    		</div>
            <div class="row justify-content-center">
                ...
                <div class="col-12 col-lg-8 col-xl-9">
                    ...
                    <div class="single-blog-post style-1 d-flex flex-wrap mb-30">
                        <!-- Blog Thumbnail -->
                        <div class="blog-thumbnail">
                            <img src="https://images.mypetlife.co.kr/content/uploads/2021/01/14092407/sick-dog-2-768x513.jpg" alt="" style="width: 330px; height: 307px;">
                        </div>
                        <!-- Blog Content -->
                        <div class="blog-content">
                            <a href="#" class="post-tag">태그?</a>
                            <a href="infoDetail.do" class="post-title">강아지가 고구마를 먹어도 될까?</a>
                            <div class="post-meta">
                                <a href="#" class="post-date">July 11, 2018</a>
                                <a href="#" class="post-author">by 작성자</a>
                            </div>
                            <p>포도나 초콜릿 같은 음식은 강아지에게 중독 증상을 일으킬 수 있어 매우 위험합니다. 그래서 이런 음식을 강아지가 먹은 경우, 응급 처치로 …</p>
                        </div>
                    </div>
                    ...
                    <div class="single-blog-post style-1 d-flex flex-wrap mb-30">
                        <!-- Blog Thumbnail -->
                        <div class="blog-thumbnail">
                            <img src="https://images.mypetlife.co.kr/content/uploads/2020/12/31105101/IMG_8056-scaled-e1609379495793-390x220.jpg" alt="">
                        </div>
                        <!-- Blog Content -->
                        <div class="blog-content">
                            <a href="#" class="post-tag">The Best</a>
                        ...
                        <div class="single-widget-area author-widget mb-30">
                            <div class="background-pattern bg-img" style="background-image: url(img/core-img/pattern2.png);">
                                <div class="author-thumbnail">
                                    <img src="../resources/bueno/img/bg-img/23.jpg" alt="">
                                </div>
