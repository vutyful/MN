...
<body>
    ...
    <header class="header-area">
        ...
        <!-- Logo Area -->
        <div class="logo-area">
            <a href="../index.jsp"><img src="../resources/idximg/logo2.png" alt=""></a>
        </div>
                        ...
                        <div class="classy-menu">
                            ...
                            <div class="classynav">
                                <ul>
                                    ...
                                    <li><a href="buenoBasic/single-post.do">마이페이지</a></li>
                                    <li><a href="buenoBasic/contact.do">Contact(예비탭)</a></li>
                                </ul>
    ...
    <!-- ##### Search Area Start ##### -->
    <!-- <div class="bueno-search-area section-padding-100-0 pb-70 bg-img" style="background-image: url(../resources/bueno/img/core-img/pattern.png);">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <form action="#" method="post">
                            ...
                            <form action="#" method="post">
                                <div class="row">
                                    <div class="col-12 col-lg-6">
                                        <!-- <input type="text" class="form-control" id="name" placeholder="카테고리1"> -->
                                        <select id="kind">
                                    ...
                                    <div class="col-12 col-lg-6">
                                        <!-- <input type="email" class="form-control" id="email" placeholder="카테고리2"> -->
                                        <select id="#">
									        	<option value="#">글 카테고리</option>
                                    ...
                                    <div class="col-12">
                                        <!-- <textarea name="message" class="form-control" id="message" cols="30" rows="10" placeholder="내용 웹에디터를 넣어라!!"></textarea> -->
	                                    <div id="summernote"></div>
                                    </div>
  
                                    <div class="col-12">
                                        <button class="btn bueno-btn mt-30" type="submit">작성</button>
                                        <button class="btn bueno-btn mt-30" type="submit">취소</button>
                                    </div>
